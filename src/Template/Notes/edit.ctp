...
<div class="add-section">
	<section id="add-note">
	   	...
	   	<div id="add-form">
	   	<h3>Edit Note</h3><br />
	    <?= $this->Form->create('Note', ['enctype' => 'multipart/form-data']) ?>

	            <?= $this->Form->input('subject', ['value' => $note['subject']]) ?>

	            <?= $this->Form->input('content',
	            	['value' => $note['content'], 'type' => 'textarea', 'style' => 'width:100%;height:300px;']) ?>

	            <?= $this->Form->input('file', ['type' => 'file']) ?><br />
				 <form action="/notes/edit" style="margin:0px;float:right;">
